/**
 * A class that holds and manipulates data of a Satellite revolving around earth.
 * Contains methods that calculate its acceleration along the y and x axes, that 
 * determine whether or not it's crashed, and that determine its altitude and distance.
 * *Page 101, Problem 18
 * @author Adam Pape
 */
public class Satellite {
  ...
  //Constants
    ...
    // Mass of the Earth
    public final double M = 5.97 * Math.pow(10,24);

    // Radius of the Earth
    public final int EARTH_RADIUS = 6378137;
